...
#'           Aggregates = Aggdt)
#'           
#' newAggdt <- new( Class='DDdt',data.table(
#'     Variable = c( 'NACE09', 'Turnover'),
#'     Sort = c(rep('IDQual', 1), 'IDDD'),
#'     Class = c(rep('character', 1), 'numeric'),
#'     Qual1 = c(rep('', 1), 'Province'),
#'     Qual2 = c(rep('', 1), 'NACE09'),
