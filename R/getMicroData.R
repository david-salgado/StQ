#' @title Return slot MicroData from a DD object
#'
#' @description \code{getMicroData} returns slot \code{MicroData} of the input
#' \linkS4class{DD} object.
#' 
#' @param object a DD Object whose slot \code{MicroData} is queried.
#'
#' @return \linkS4class{data.table} with data from slot \code{MicroData} of the
